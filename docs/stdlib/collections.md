...
| `heap.vr`           | **stable** | [core-tests/collections/heap](https://github.com/verum-lang/verum/tree/main/core-tests/collections/heap) — **11/11 green** on `--interp` validated 2026-05-25 (commit `bd2553407`: Heap.into_inner CBGR runtime intercept closed the last gating defect — was 10/11 pre-fix). All BinaryHeap operations + Heap wrapper round-trip validated. |
