...
| `bloom.vr`          | **partial** | [core-tests/collections/bloom](https://github.com/verum-lang/verum/tree/main/core-tests/collections/bloom) — `BloomFilter.try_new` and the error variants are covered.  |
