...
status_detail: Conformance suites landed in core-tests/action/ on 2026-05-24. Subset of public surface verified under --interp; cross-tier --aot validation deferred until a tracked toolchain task (AOT stdlib build cascade) closes.
slug: /stdlib/action
---
