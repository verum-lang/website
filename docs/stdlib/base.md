...
status: partial
status_detail: 7 complete (maybe / result / cell / coercion / error / uuid / primitives 60/60), 23 partial (incl. coinductive 4/4 + string_distance 4/4 + snowflake 4/4 + ulid 4/4 + nanoid 4/4 — 2026-05-27 sweep), 2 regression-only (semver / retry), 1 undocumented (semver_constraint). See per-module status table below for the truth-table over each `core.base.*` submodule.
---
