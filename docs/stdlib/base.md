...
| `cell.vr`            | **partial** | [core-tests/base/cell](https://github.com/verum-lang/verum/tree/main/core-tests/base/cell) — the `Cell` family is stable and `Ref` / `RefMut` auto-deref through `RefCell` works.  |
