...
status: partial
status_detail: 7 complete (maybe / result / cell / coercion / error / uuid / primitives 60/60), 19 partial (incl. coinductive 4/4 — 2026-05-26 sweep), 4 regression-only, 2 undocumented (string_distance / semver_constraint). See per-module status table below for the truth-table over each `core.base.*` submodule.
---
