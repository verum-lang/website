...
status: partial
status_detail: 7 complete (maybe / result / cell / coercion / error / uuid / primitives 60/60), 26 partial (incl. coinductive 4/4 + string_distance 4/4 + snowflake 4/4 + ulid 4/4 + nanoid 4/4 + semver 4/4 + retry 4/4 + semver_constraint 4/4 — 2026-05-27 sweep), 0 regression-only, 0 undocumented. All 27 base submodules now documented; complete coverage of base/ achieved. See per-module status table below for the truth-table over each `core.base.*` submodule.
---
