...
status: partial
status_detail: 7 complete (maybe / result / cell / coercion / error / uuid / primitives 60/60), 20 partial (incl. coinductive 4/4 + string_distance 4/4 — 2026-05-26 sweep), 4 regression-only, 1 undocumented (semver_constraint). See per-module status table below for the truth-table over each `core.base.*` submodule.
---
