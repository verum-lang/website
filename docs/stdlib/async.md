...
|---|---|---|
| `poll.vr`          | **partial** | [core-tests/async/poll](https://github.com/verum-lang/verum/tree/main/core-tests/async/poll) — 42 unit + 21 property + 14 integration + 7 regression-as-guardrail (79 working, 0 pinned) |
...
| `generator.vr`     | unverified   | — runtime-bound; deferred pending the executor test-bed |
