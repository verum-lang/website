...
const sidebars: SidebarsConfig = {
  docs: [
    ...
    {
      type: 'category',
      label: 'Architecture-as-Types (ATS-V)',
      ...
      items: [
        'architecture-types/index',
        {
          ...
          link: {type: 'doc', id: 'architecture-types/cve/overview'},
          items: [
            'architecture-types/cve/overview',
            'architecture-types/cve/three-axes',
            'architecture-types/cve/seven-configurations',
        ...
        },
        {
          ...
          items: [
            ...
            'architecture-types/primitives/capability',
            'architecture-types/primitives/boundary',
            'architecture-types/primitives/composition',
            'architecture-types/primitives/lifecycle',
            'architecture-types/primitives/foundation',
        ...
        },
        {
          ...
          items: [
            ...
            'architecture-types/anti-patterns/classical',
            'architecture-types/anti-patterns/articulation',
            'architecture-types/anti-patterns/coherence',
            'architecture-types/anti-patterns/mtac',
          ],
        },
        'architecture-types/orthogonality',
        'architecture-types/mtac',
        ...
        'architecture-types/dual-audience',
        'architecture-types/self-application',
    ...
    },
    {
      ...
      items: [
        ...
        'verification/kernel-module-map',
        'verification/kernel-v0',
        'verification/two-kernel-architecture',
        'verification/reflection-tower',
        'verification/separation-logic',
        'verification/codegen-attestation',
  ...
  stdlib: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: 'category',
          label: 'Weft (server framework)',
          link: {type: 'doc', id: 'stdlib/net/weft/overview'},
          items: [
            'stdlib/net/weft/service',
            'stdlib/net/weft/handler',
            'stdlib/net/weft/router',
            'stdlib/net/weft/listener',
            'stdlib/net/weft/error',
            'stdlib/net/weft/refined_routes',
            'stdlib/net/weft/connection',
            'stdlib/net/weft/transport',
            'stdlib/net/weft/backpressure',
            'stdlib/net/weft/spiffe',
            'stdlib/net/weft/dst',
          ],
        },
        'stdlib/proxy',
